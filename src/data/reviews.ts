...
export const reviews: Review[] = [
  {
    id: 'r1',
    testo: "Salvatore ci ha portati in una cala dove non c'era nessun altro e ha cucinato la pasta a bordo. Mio figlio di sei anni non voleva più scendere.",
    autore: 'Chiara M.',
  ...
  {
    id: 'r3',
    testo: 'Barca pulita, equipaggio simpatico, soste nei posti giusti al momento giusto per evitare la folla. Rifaremmo tutto.',
